   ...
   ;Copyright © 2016 University Corporation for Atmospheric Research (UCAR). All rights reserved.
    ...
    CASE uname OF
        'loadfile': BEGIN ;===========================================================================
            ...
            IF op.rakefix eq 1 THEN checkboxarray[where(values eq 'Rake Fix')]=1
        ...
        'process':BEGIN ;===========================================================================
            ...
            IF iadv[where(values eq 'Rake Fix')] eq 1 THEN rakefix=1 ELSE rakefix=0
            ...
            op={fn:fn, date:date[0], starttime:hms2sfm(starttime), stoptime:hms2sfm(stoptime), format:probe.format, $
               ...
               wavelength:probe.wavelength, seatag:probe.seatag, ncdfparticlefile:ncdfparticlefile, centerin:1, centerinrejection:1, rakefix:rakefix}
...
PRO soda2_hiwc
   ...
   ;Copyright © 2016 University Corporation for Atmospheric Research (UCAR). All rights reserved.
    ...
    ;----------Main widget setup-------------------------------------------
    base = WIDGET_BASE(COLUMN=1,title='SODA-2 Processing Software Version HIWC',MBar=menubarID)
    ...
    projectname=cw_field(subbase2d,/string,title='Project Name',uname='project',xsize=15,value='HIWC',/column)
    ...
    rate=cw_field(subbase2a,/float, title='Averaging Time (s):',uname='rate' , xsize=6, value=1.0)
    ...
    vals=['Shatter Correct','All-In','Water Processing','Stuck Bit Correct','Pixel Noise Filter','Area Size','Rake Fix']
    advanced=cw_bgroup(subbase2c,vals,uname='options',/row,/nonexclusive,uval=vals,set_value=[1,0,0,0,0,1,0])
